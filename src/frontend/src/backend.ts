...
export class Backend implements backendInterface {
    ...
    async addStamp(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addStamp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllUsersLoyaltyData(): Promise<Array<[Principal, LoyaltyResponse]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUsersLoyaltyData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserLoyaltyData(): Promise<LoyaltyResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserLoyaltyData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async redeemVoucher(arg0: Principal, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.redeemVoucher(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
